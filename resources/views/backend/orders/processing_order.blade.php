			...
			<div class="col-12">
			    <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">Processing Order List <span class="badge badge-pill badge-danger"> {{ count($orders) }} </span></h3>
                    </div>
				    <!-- /.box-header -->
				    <div class="box-body">
					        ...
					        <table id="example1" class="table table-bordered table-striped">
						        ...
						        <tbody>
                                    @foreach($orders as $item)
                                        <tr>
                                            <td width="15%"> {{ $item->order_date }} </td>
                                            <td>{{ $item->invoice_no }}</td>
                                            <td width="20%">@currency($item->amount)</td>
