...
<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.js"></script>
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <ul class="list-group">
                ...
                <li class="list-group-item">Stock: <span class="badge badge-pill badge-success" id="avaiable" style="background: green; color: white; margin-right:90px;"></span> 
                  <span class="badge badge-pill badge-danger" id="stockout" style="background: red; color: white; margin-right:90px;"></span> 
              </ul>
            </div>
            <div class="col-md-4" >
  ...
  <script type="text/javascript">
    ...
    // Function Product view with modal
    ...
    function miniCart(){
      $.ajax({
          ...
          success:function(response){
            ...
            $('#cartSubTotal').autoNumeric('init');
            $('#cartTotal').autoNumeric('init');
                    ...
                    <div class="product-name" ><h4><strong>${value.name}</strong></h4></div>
                            ...
                            <td class="col-md-2" >
                              ${value.options.color == null
                                ? `<h5 style="margin-left:25px;"><strong> .... </h5></strong>`
                                :
                              `<h5 style="margin-left:25px;"><strong>${value.options.color} </strong></h5>` 
                              } 
                            </td>
                            <td class="col-md-2">
                              ${value.options.size == null
                                ? `<h5 style="margin-left:25px;"><strong> .... </h5></strong>`
                                :
                              `<h5 style="margin-left:25px;"><strong>${value.options.size} </strong></h5>` 
                              }           
                                </td>
                            <td class="col-md-2">
                              ${value.qty > 1
                                ...
                                <input type="text" value="${value.qty}" min="1" max="100" disabled="" style="width:15px;" >      
                                <button type="submit" class="btn btn-success btn-sm" id="${value.rowId}" onclick="cartIncrement(this.id)" >+</button>    
                              </td>
                            <td class="col-md-2">
                              
                              <h5><strong>Rp.${value.subtotal}</strong></h5> 
                            </td>
...
<script type="text/javascript">
  function totalCalculation(){
    $.ajax({
        type:'GET',
        url: "{{ url('/user/total-calculation') }}",
        dataType: 'json',
        success:function(data){
            if (data.total) {
                $('#TotalField').html(
