                ...
                <div class="box overflow-hidden pull-up">
                    <div class="box-body">							
                        ...
                        <div>
                            ...
                            <h3 class="text-white mb-0 font-weight-500">@currency($today) {{-- <small class="text-success"><i class="fa fa-caret-up"></i> IDR</small> --}}</h3>
                ...
                <div class="box overflow-hidden pull-up">
                    <div class="box-body">							
                        ...
                        <div>
                            ...
                            <h3 class="text-white mb-0 font-weight-500">@currency($month) {{-- <small class="text-success"><i class="fa fa-caret-up"></i>IDR</small> --}} </h3>
                ...
                <div class="box overflow-hidden pull-up">
                    <div class="box-body">							
                        ...
                        <div>
                            ...
                            <h3 class="text-white mb-0 font-weight-500">@currency($year) {{-- <small class="text-danger"><i class="fa fa-caret-down"></i> IDR</small> --}} </h3> 
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <tbody>
                                    @foreach($orders as $item)
                                        <tr>										
                                            ...
                                            <td>
                                                <span class="text-danger font-weight-600 d-block font-size-16">
                                                    {{ $item->invoice_no }}
                                                </span>
                                            </td>
                                            <td>
